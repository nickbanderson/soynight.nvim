local c = require 'soynight.colors'
local config = require 'soynight.config'
...
M.base = {
  ...
  NormalFloat = { fg = c.purple, bg = c.dark },
  ...
  TabLine = { fg = c.light_gray, bg = c.dark, style = 'none' },
  TabLineFill = { fg = c.fg, bg = c.dark, style = 'none' },
  TabLineSel = { fg = c.fg, bg = c.dark, style = 'underline' },
  Tag = { fg = c.blue },
